...
function editPostValidation(){
    ...
    if(!editApllicationFeeValue.match(editApllicationFeeRegEx)){
    ...
    if(!editownerNameValue.match(editOwnerRegex)){
        editownerName.value = "";
        editownerName.placeholder = "Please Enter Organizer Name Correctly";
    ...
    if(fullDayEventCheckBox.checked){
       if(upComingEventStartDateValue == null || upComingEventStartDateValue == ""){
            fullDayEventErrorMessage.textContent = "Please Fill  Start Date";
            upComingEventStartDate.focus();
            upComingEventStartDate.onclick = function(){
                fullDayEventErrorMessage.textContent = "";
            }
            return false;
       }
    }else {
        if(upComingEventStartDateValue == null || upComingEventStartDateValue == "" || upComingEventStartTimeValue == null || upComingEventStartTimeValue == ""){
            fullDayEventErrorMessage.textContent = "Please Fill Start Date and Start Time ";
    ...
    if(addEndTimeEventCheckBox.checked){
        if(upComingEventEndDateValue == null || upComingEventEndDateValue == "" || upComingEventEndTimeValue == null || upComingEventEndTimeValue == ""){
            fullDayEventErrorMessage.textContent = "Please Fill End Date and End Time Also ";
