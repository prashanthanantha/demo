...
function editPostValidation(){
    ...
    var editOpenHours = document.getElementsByClassName("validating_time");
    var editPoojaTime = document.getElementsByClassName("validating_pooja_time");
    ...
    //open hours validations
    var openHoursDateErrorMsg = document.getElementById("time_error_box_msg_bg");
    for(var i = 0; i < editOpenHours.length; i++){
        
        if(editOpenHours[i].value === null || editOpenHours[i].value === ""){
            openHoursDateErrorMsg.textContent = "please fill open Hours Time";
            editOpenHours[i].classList.add("new_input_error_bg");
            editOpenHours[i].focus();
            editOpenHours[i].onclick = function(){
                editOpenHours[i].classList.remove("new_input_error_bg");
                openHoursDateErrorMsg.textContent = "";
            }
            return false;
        }
    ...
    //edit pooja time validations
    var poojaTimeDateErrorMsg = document.getElementById("pooja_time_error_box_msg_bg");
    for(var i = 0; i < editPoojaTime.length; i++){
        if( 
            ( (editPoojaTime[0].value === null || editPoojaTime[0].value === "") || 
            (editPoojaTime[1].value === null || editPoojaTime[1].value === "") ) && 
            ( (editPoojaTime[2].value === null || editPoojaTime[2].value === "") || 
            (editPoojaTime[3].value === null || editPoojaTime[3].value === "") ) &&
            ( (editPoojaTime[4].value === null || editPoojaTime[4].value === "") ||
            (editPoojaTime[5].value === null || editPoojaTime[5].value === "") ) && 
            ( (editPoojaTime[6].value === null || editPoojaTime[6].value === "") ||
            (editPoojaTime[7].value === null || editPoojaTime[7].value === "") ) &&
            ( (editPoojaTime[8].value === null || editPoojaTime[8].value === "") ||
            (editPoojaTime[9].value === null || editPoojaTime[9].value === "") ) &&
            ( (editPoojaTime[10].value === null || editPoojaTime[10].value === "") ||
            (editPoojaTime[11].value === null || editPoojaTime[11].value === "") ) &&
            ( (editPoojaTime[12].value === null || editPoojaTime[12].value === "") ||
            (editPoojaTime[13].value === null || editPoojaTime[13].value === "") )
          )
        
        {
            poojaTimeDateErrorMsg.textContent = "please fill atleast one day pooja timings";
            
            for( i = 0;i < editPoojaTime.length; i++ ){
                    editPoojaTime[i].classList.add("error_msg_box");
                    editPoojaTime[i].focus();
                    editPoojaTime[i].onclick = function(){   
                        for( i = 0;i < editPoojaTime.length; i++ ){                         
                            editPoojaTime[i].classList.remove("error_msg_box");
                        }    
                        poojaTimeDateErrorMsg.textContent = "";
